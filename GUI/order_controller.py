...
class MainWindow_controller(QtWidgets.QMainWindow):
    ...
    def order(self):
        ...
        store = self.ui.comboBox_store.currentIndex()
        eat_time = self.ui.comboBox_eat_time.currentIndex()
        order_date = self.ui.dateEdit_order_date.date().toString('yyyy-MM-dd')
        restaurant = self.ui.comboBox_restaurant.currentIndex()
